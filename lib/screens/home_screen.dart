...
import 'package:gift_planner/widget/navbar.dart';
          ...
          Consumer<CartProvider>(
            builder: (context, cartProvider, child) {
              final int cartItemCount =
                  cartProvider.itemCount; // عدد العناصر في السلة
              ...
              return Stack(
                children: [
                  ...
                  if (cartItemCount > 0) // إذا كانت السلة تحتوي على عناصر
                    Positioned(
                      right: 0,
                      top: 0,
                      child: CircleAvatar(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Text.rich(
        TextSpan(
          style: TextStyle(color: AppStyles.foregroundColor),
          children: [
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        TextButton(
          onPressed: () {
            Navigator.pushNamed(context, "/prodect");
          },
...
class PopularProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CartProvider>(
      builder: (context, cartProvider, child) {
        final searchQuery = cartProvider.searchQuery;
        final filteredProducts = cartProvider.filteredProducts;

        // إذا كان البحث يحتوي على نص ولم يتم العثور على منتجات
        if (searchQuery.isNotEmpty && filteredProducts.isEmpty) {
          return Center(
            child: Text(
              'No products found for "$searchQuery"',
              style: AppStyles.texStyle1,
            ),
          );
        }
        ...
        return Column(
          children: [
            ...
            // عرض المنتجات التي تم العثور عليها
  ...
  Widget build(BuildContext context) {
    return Consumer<CartProvider>(
      builder: (context, cartProvider, child) {
        ...
        // Display the grid of filtered products
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ProductCard(
              product: product,
              onPress: () {
                // Action when product card is pressed
              },
              onAddToCart: () {
                // Action when "Add to Cart" is clicked
                cartProvider.addToCart(product);
              },
              onToggleFavorite: () {
                // Action when favorite toggle is clicked
              },
